...
extension AVCaptureDevice {
    public func availableFormatsFor(preferredFps: Float64) -> [AVCaptureDevice.Format] {
    ...
    public func formatWithHighestResolution(_ availableFormats: [AVCaptureDevice.Format]) -> AVCaptureDevice.Format?
    {
    ...
    public func formatFor(preferredSize: CGSize, availableFormats: [AVCaptureDevice.Format]) -> AVCaptureDevice.Format?
    {
        for format in availableFormats {
            let dimensions = CMVideoFormatDescriptionGetDimensions(format.formatDescription)
